...
include_once APP_PATH . '/logic/viewLogsLogic.php';
?>
...
<head>
  ...
  <link href="assets/vendor/responsive/css/responsive.dataTables.css" rel="stylesheet">
  <link href="assets/vendor/responsive/css/responsive.bootstrap4.css" rel="stylesheet">
</head>
...
<body id="page-top">
  ...
  <script src="assets/vendor/responsive/dataTables.responsive.js"></script>
  <script src="assets/vendor/responsive/responsive.bootstrap4.js"></script>
  ...
  <script type="text/javascript">
    ...
    function Export()
    {
      var conf = confirm("Export Logs to CSV?");
        if(conf == true)
        {
          window.open("includes/exportLogs.php", "_blank", false);
        }
    }
  </script>
