            ...
            <div class="card-body">
              <div class="pl-2 pb-2 pt-2 mb-3 border rounded">
                ...
                <?php foreach ($columns as $column): ?>
                  <a href="#" class="toggle-vis" data-column="<?php echo $i; ?>" data-label-text="<?php echo $column ?>" >
                    <?php echo $column ?>
                  </a> |
                  <?php $i++;?>
                  <?php endforeach;?>
                      ...
                      <tr class="<?php echo ($clientData->is_usb == "yes") ? "text-primary" : "" ?>">
                        ...
                        <td class="text-center">
                          <?php if ($countries[strtoupper($clientData->country)] == "Unknown"): ?>
                            <img src="images/flags/X.png">
                          <?php else: ?>
                            <img src="images/flags/<?php echo $clientData->country; ?>.png">
                          <?php endif;?>
